<template>
    <div>
        ...
        <el-table :data="paramsData">
            ...
            <el-table-column prop="itemCatId" label="产品管理ID" width="100"></el-table-column>
        ...
        <el-dialog title="添加规格参数" :visible.sync="dialogParmasVisible" width="65%" :before-close="handleClose">
            <ParamsTree @onTree="getTreeData" />
            <el-dialog title="添加参数" :visible.sync="dialogInnerParamsVisible" width="60%" :before-close="handleClose"
                append-to-body>
                <el-button @click="addMainParamsHandle">添加主结构</el-button>
                <el-form :model="paramsDoMain" ref="paramsDoMain">
                    <el-form-item label="规格参数" v-for="(item, index) in paramsDoMain.domains" :key="index">
                        ...
                        <div v-for="(childItem, childIndex) in item.children" :key="childIndex">
                            <el-input v-model="childItem.childIndex" style="width: 60%" placeholder="添加子结构"></el-input>
